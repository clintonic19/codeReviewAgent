import { w as withoutTrailingSlash$1, d as generateId$1, e as withUserAgentSuffix, l as loadApiKey$1, f as createJsonErrorResponseHandler$1, h as lazySchema, p as parseProviderOptions, i as combineHeaders$1, r as resolve, k as postJsonToApi$1, m as createJsonResponseHandler$1, n as createEventSourceResponseHandler$1, o as createProviderDefinedToolFactory, v as validateTypes$1, q as convertToBase64, z as zodSchema, u as createProviderDefinedToolFactoryWithOutputSchema, x as isParsableJson$1, y as loadOptionalSetting, A as lazyValidator, B as createBinaryResponseHandler, C as convertBase64ToUint8Array, D as mediaTypeToExtension, E as postFormDataToApi } from './index3.mjs';
import { o as object, s as string, f as boolean, g as array, u as union, h as literal, n as number, k as looseObject, j as discriminatedUnion, i as unknown, r as record, _ as _enum, x as tuple, a as any, l as lazy, z as number$1 } from './coerce.mjs';
...
function createOpenAICompatible(options) {
  ...
  const getHeaders = () => withUserAgentSuffix(headers, `ai-sdk/openai-compatible/${VERSION$2}`);
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-4VGIWYS3.mjs');

...
import { i as isVercelTool, v as validateToolInput } from './core.mjs';
import { g as getDefaultExportFromCjs, M as MastraBase } from './_commonjsHelpers.mjs';
import { L as LogLevel, C as ConsoleLogger, R as RegisteredLogger } from './chunk-UXG7PYML.mjs';
import { createHash } from 'crypto';
import { ZodFirstPartyTypeKind as ZodFirstPartyTypeKind$1, z } from './zod.mjs';
import { s as setResponseValueAndErrors, p as parseStringDef, a as addErrorMessage, z as zodToJsonSchema$1 } from './zod-to-json.mjs';
import { t as trace, S as SpanStatusCode } from './trace-api.mjs';
import { u as union, s as string, c as _instanceof, d as custom, l as lazy, e as _null, n as number, f as boolean, r as record, g as array, o as object$1, h as literal, i as unknown, m as optional, D as ZodNumber$1, _ as _enum, E as ZodString$1, a as any, Z as ZodArray$1, x as tuple, F as intersection, C as ZodObject$1, G as ZodRecord, B as never, H as ZodOptional$1, I as ZodNull$1, J as ZodUnion$1, K as ZodDate$1, L as ZodDefault$1, M as ZodNever$1, A as strictObject, N as ZodUnknown$1, k as looseObject } from './coerce.mjs';
...
var TypeHandler = class {
  apply(types, schema) {
    ...
    if (typeSet.has("integer") && types.number !== false) {
      ...
      if (currentNumber instanceof ZodNumber$1) {
...
var MinLengthHandler = class {
  apply(types, schema) {
    ...
    if (types.string !== false) {
      ...
      if (currentString instanceof ZodString$1) {
...
var ItemsHandler = class {
  apply(types, schema) {
    ...
    if (Array.isArray(arraySchema.items)) {
      ...
      if (types.array && types.array instanceof ZodArray$1) {
...
var ObjectPropertiesHandler = class {
  apply(zodSchema, schema) {
    ...
    if (zodSchema instanceof ZodObject$1 || zodSchema instanceof ZodRecord) {
      const shape = {};
      if (objectSchema.properties) {
...
export { AISpanType as A, createMastraProxy as B, wrapMastra as C, DeepSeekSchemaCompatLayer as D, selectFields as E, ModelSpanTracker as F, GoogleSchemaCompatLayer as G, TypeValidationError as H, customAlphabet as I, JSONParseError as J, InvalidArgumentError$1 as K, APICallError as L, MetaSchemaCompatLayer as M, AISDKError as N, OpenAIReasoningSchemaCompatLayer as O, convertJsonSchemaToZod$1 as P, convertJsonSchemaToZod as Q, ToolStream as T, getAllAITracing as a, shutdownAITracingRegistry as b, checkEvalStorageFields as c, deepMerge as d, parseSqlIdentifier as e, convertToCoreMessages as f, generateEmptyFromSchema as g, convertUint8ArrayToBase64 as h, fetchWithRetry as i, OpenAISchemaCompatLayer as j, AnthropicSchemaCompatLayer as k, applyCompatLayer as l, isZodType as m, jsonSchema as n, output_exports as o, parseFieldKey as p, generateText as q, generateObject as r, setupAITracing as s, streamText as t, streamObject as u, delay as v, getOrCreateSpan as w, getValidTraceId as x, ensureToolProperties as y, makeCoreTool as z };
